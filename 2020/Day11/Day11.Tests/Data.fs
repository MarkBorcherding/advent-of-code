...
module Data =
  ...
  let dropWhitespace s = Regex(@" ").Replace(s,"")
  let cleanup = dropWhitespace
  ...
  let part2 = [|
     "L.LL.LL.LL
      ...
      LLL###LLL#
      #.LLLLL#.L
      #.L#LL#.L#" |] |> Array.map cleanup
      
      
  let myInput = "LLLLLLLLLLLL.LLLLLLLLLL.LLLL.LLLL.LLLLLLLLLLL.LLLL.LLLLLLL.LL.LLLLLLLL.LLL.LLLLLLLLLLL.LLLLLLL
                 ...
                 LLLLLL.LLLL.LLLLLLLLLLL.LLLL.LLLLL.LLLLLLLLLL.LLLLLLLL..LLLLL.LL.LLLLL.LLL.LL.L.LLLLLLLLLLLLLL" |> cleanup
