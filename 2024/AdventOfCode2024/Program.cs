...
for (int i = 0; i < args.Length; i++)
{
    ...
    else
    {
        ...
        Console.WriteLine("Usage: AdventOfCode2024 --day <day> --part <part> [--input|--example]");
        Console.WriteLine("Example: AdventOfCode2024 --day 1 --part 1 --input");
        Console.WriteLine("         AdventOfCode2024 --day 1 --part 2 --example");
        return 1;
    }
}
...
var puzzleTypeName = $"AdventOfCode2024.Days.Day{day.Value:D2}.Day{day.Value:D2}";
